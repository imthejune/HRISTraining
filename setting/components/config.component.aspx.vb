...
Partial Class setting_components_config_component
    Inherits System.Web.UI.Page

    Private Sub setting_components_config_component_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Sub Startload()
        ...
        'str = str
        'Dim conne As New connections

        'Dim indata = conne.info()
