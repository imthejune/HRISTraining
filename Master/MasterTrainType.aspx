<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MasterTrainType.aspx.vb" Inherits="Master_MasterTrainType" %>
                ...
                function gridCommand(sender, args) {
                    if (args.get_commandName() == "BatchEdit") {
                        ...
                        for (var i = 0; i < dataItems.length; i++) {
                            var idCellGUID = dataItems[i].get_cell("Type_PaternNameT"); //get reference to the cells you want to validate


                            var idGUID = batchManager.getCellValue(idCellGUID); //retrieve the value from the cell using the BatchEditingManager 

                            if (idGUID == "") {
                                if (idGUID == "") msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("Type_PaternNameT").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าว่างเปล่า%>" + "<br/>";
                        ...
                        if (itemCNT >= 0) {
                            msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("Type_PaternNameT").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าซ้ำ%>" + "<br/>";
                            validationFails = true;
                        }
                        else {
        ...
        <div>
            <telerik:RadGrid ID="GridShowdata" runat="server" AllowMultiRowEdit="True"
                ...
                <MasterTableView CommandItemDisplay="Top" CommandItemSettings-ShowRefreshButton="false"
                    ...
                    EditMode="Batch" EnableNoRecordsTemplate="true" DataKeyNames="GUID_Type_Patern">
                    <BatchEditingSettings EditType="Cell" OpenEditingEvent="Click" />
                    <NoRecordsTemplate></NoRecordsTemplate>
                    <ItemStyle Height="28px" />
                    <AlternatingItemStyle Height="28px" />
                    <Columns>
                        <telerik:GridBoundColumn UniqueName="GUID_Type_Patern" DataField="GUID_Type_Patern" HeaderText="ID"  Visible="false"/>
                        <telerik:GridBoundColumn UniqueName="Type_PaternNameT" SortExpression="Type_PaternNameT" DataField="Type_PaternNameT" HeaderText="ชื่อชนิดการอบรม(ไทย)" HeaderStyle-Width="130px" AllowSorting="true" ColumnEditorID="txtEditor2" />
                        <telerik:GridBoundColumn UniqueName="Type_PaternNameE" SortExpression="Type_PaternNameE" DataField="Type_PaternNameE" HeaderText="ชื่อชนิดการอบรม(อังกฤษ)" HeaderStyle-Width="130px" AllowSorting="true" ColumnEditorID="txtEditor2"/>
                        <telerik:GridBoundColumn UniqueName="Type_PaternNameO" SortExpression="Type_PaternNameO" DataField="Type_PaternNameO" HeaderText="ชื่อชนิดการอบรม(อื่นๆ)" HeaderStyle-Width="130px" AllowSorting="true" ColumnEditorID="txtEditor2"/>
                        ...
                        <telerik:GridBoundColumn UniqueName="Type_PaternID" DataField="Type_PaternID" HeaderText="Type_PaternID"  Visible="true" Display ="false"/>
                    </Columns>
                    <EditFormSettings>
            ...
            <telerik:GridTextBoxColumnEditor ID="txtEditor2"  runat="server" TextBoxStyle-Width ="129px" ></telerik:GridTextBoxColumnEditor>               
