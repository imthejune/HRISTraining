<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MasterVt.aspx.vb" Inherits="Master_MasterVt" %>
                ...
                function gridCommand(sender, args) {
                    if (args.get_commandName() == "BatchEdit") {
                        ...
                        for (var i = 0; i < dataItems.length; i++) {
                            var idCellGUID = dataItems[i].get_cell("Vt_N"); //get reference to the cells you want to validate
                            var idCellName = dataItems[i].get_cell("Vt_Name"); //get reference to the cells you want to validate
                            ...
                            if (idGUID == "" || idName == "") {
                                if (idGUID == "") msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("Vt_N").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าว่างเปล่า%>" + "<br/>";
                                if (idName == "") msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("Vt_Name").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าว่างเปล่า%>" + "<br/>";
                        ...
                        if (itemCNT >= 0) {
                            msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("Vt_N").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าซ้ำ%>" + "<br/>";
                        validationFails = true;
                    }
                    else {
        ...
        <div>
            <telerik:RadGrid ID="GridShowdata" runat="server" AllowMultiRowEdit="True"
                ...
                <MasterTableView CommandItemDisplay="Top" CommandItemSettings-ShowRefreshButton="false"
                    ...
                    EditMode="Batch" EnableNoRecordsTemplate="true" DataKeyNames="Vt_ID">
                    ...
                    <Columns>
                       ...
                       <telerik:GridBoundColumn UniqueName="Vt_ID" DataField="Vt_ID" HeaderText="ID"  Visible="false"/>
                        <telerik:GridBoundColumn UniqueName="Vt_N" SortExpression="Vt_N" DataField="Vt_N" HeaderText="ลำดับ" HeaderStyle-Width="100px" AllowSorting="true" ColumnEditorID="txtEditor1" AutoPostBackOnFilter="false" />
                        <telerik:GridBoundColumn UniqueName="Vt_Name" SortExpression="Vt_Name" DataField="Vt_Name" HeaderText="วัตถุประสงค์" HeaderStyle-Width="120px" AllowSorting="true" ColumnEditorID="txtEditor2"/>
