<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MasterGroup.aspx.vb" Inherits="Master_MasterGroup" %>
                ...
                function gridCommand(sender, args) {
                    if (args.get_commandName() == "BatchEdit") {
                        ...
                        for (var i = 0; i < dataItems.length; i++) {
                            var idCellGUID = dataItems[i].get_cell("Group_Code"); //get reference to the cells you want to validate
                            var idCellName = dataItems[i].get_cell("Group_NameT"); //get reference to the cells you want to validate
                            ...
                            if (idGUID == "" || idName == "") {
                                if (idGUID == "") msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("Group_Code").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าว่างเปล่า%>" + "<br/>";
                                if (idName == "") msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("Group_NameT").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าว่างเปล่า%>" + "<br/>";
                    ...
                    if (itemCNT >= 0) {
                        msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("Group_Code").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าซ้ำ%>" + "<br/>";
                        validationFails = true;
                    }
                    else {
        ...
        <div>
            <telerik:RadGrid ID="GridShowdata" runat="server" AllowMultiRowEdit="True"
                ...
                <MasterTableView CommandItemDisplay="Top" CommandItemSettings-ShowRefreshButton="false"
                    ...
                    EditMode="Batch" EnableNoRecordsTemplate="true" DataKeyNames="GUID_Group">
                    ...
                    <Columns>
                       ...
                       <telerik:GridBoundColumn UniqueName="GUID_Group" DataField="GUID_Group" HeaderText="ID"  Visible="false"/>
                        <telerik:GridBoundColumn UniqueName="Group_Code" SortExpression="Group_Code" DataField="Group_Code" HeaderText="รหัสหมวด" HeaderStyle-Width="100px" AllowSorting="true" ColumnEditorID="txtEditor1" AutoPostBackOnFilter="false" />
                        <telerik:GridBoundColumn UniqueName="Group_NameT" SortExpression="Group_NameT" DataField="Group_NameT" HeaderText="ชื่อหมวด" HeaderStyle-Width="120px" AllowSorting="true" ColumnEditorID="txtEditor2"/>
                        <telerik:GridBoundColumn UniqueName="Group_NameE" SortExpression="Group_NameE" DataField="Group_NameE" HeaderText="ชื่อหมวด(อังกฤษ)" HeaderStyle-Width="120px" AllowSorting="true" ColumnEditorID="txtEditor2"/>
                        <telerik:GridBoundColumn UniqueName="Group_NameO" SortExpression="Group_NameO" DataField="Group_NameO" HeaderText="ชื่อหมวด(อื่นๆ)" HeaderStyle-Width="120px" AllowSorting="true" ColumnEditorID="txtEditor2"/>
