<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MasterInstitue.aspx.vb" Inherits="Master_MasterInstitue" %>
                ...
                function gridCommand(sender, args) {
                    if (args.get_commandName() == "BatchEdit") {
                        ...
                        for (var i = 0; i < dataItems.length; i++) {
                            var idCellGUID = dataItems[i].get_cell("InstitueTrainNameT"); //get reference to the cells you want to validate
                            

                            var idGUID = batchManager.getCellValue(idCellGUID); //retrieve the value from the cell using the BatchEditingManager 

                            if (idGUID == "") {
                                if (idGUID == "") msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("InstitueTrainNameT").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าว่างเปล่า%>" + "<br/>";
                        ...
                        if (itemCNT >= 0) {
                            msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("InstitueTrainNameT").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าซ้ำ%>" + "<br/>";
                            validationFails = true;
                        }
                        else {
        ...
        <div>
            <telerik:RadGrid ID="GridShowdata" runat="server" AllowMultiRowEdit="True"
                ...
                <MasterTableView CommandItemDisplay="Top" CommandItemSettings-ShowRefreshButton="false"
                    ...
                    EditMode="Batch" EnableNoRecordsTemplate="true" DataKeyNames="GUID_Institue">
                    ...
                    <Columns>
                       ...
                       <telerik:GridBoundColumn UniqueName="GUID_Institue" DataField="GUID_Institue" HeaderText="ID"  Visible="false"/>
                        <telerik:GridBoundColumn UniqueName="InstitueTrainNameT" SortExpression="InstitueTrainNameT" DataField="InstitueTrainNameT" HeaderText="ชื่อสถานที่(ไทย)" HeaderStyle-Width="120px" AllowSorting="true" ColumnEditorID="txtEditor2" />
                        <telerik:GridBoundColumn UniqueName="InstitueTrainNameE" SortExpression="InstitueTrainNameE" DataField="InstitueTrainNameE" HeaderText="ชื่อสถานที่(อังกฤษ)" HeaderStyle-Width="120px" AllowSorting="true" ColumnEditorID="txtEditor2"/>
                        <telerik:GridBoundColumn UniqueName="InstitueTrainNameO" SortExpression="InstitueTrainNameO" DataField="InstitueTrainNameO" HeaderText="ชื่อสถานที่(อื่นๆ)" HeaderStyle-Width="120px" AllowSorting="true" ColumnEditorID="txtEditor2"/>
                        <telerik:GridBoundColumn UniqueName="InstitueTrainTel" DataField="InstitueTrainTel" HeaderText="เบอร์ติดต่อ" HeaderStyle-Width="100px" AllowSorting="true" ColumnEditorID="txtEditor1"/>
                        <telerik:GridBoundColumn UniqueName="InstitueTrainAddress" DataField="InstitueTrainAddress" HeaderText="ที่อยู่" HeaderStyle-Width="150px" AllowSorting="true" ColumnEditorID="txtEditor3"/>
                        <telerik:GridBoundColumn UniqueName="InstitueTrainConPerson" SortExpression="InstitueTrainConPerson" DataField="InstitueTrainConPerson" HeaderText="ผู้ติดต่อ" HeaderStyle-Width="100px" AllowSorting="true" ColumnEditorID="txtEditor1"/>
            ...
            <telerik:GridTextBoxColumnEditor ID="txtEditor3"  runat="server" TextBoxStyle-Width ="149px" ></telerik:GridTextBoxColumnEditor>                
