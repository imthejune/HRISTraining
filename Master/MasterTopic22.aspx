<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MasterTopic22.aspx.vb" Inherits="Master_MasterTopic22" %>
    ...
    <form id="form1" runat="server">
                ...
                function gridCommand(sender, args) {
                    if (args.get_commandName() == "BatchEdit") {
                        ...
                        for (var i = 0; i < dataItems.length; i++) {
                            var idCellGUID = dataItems[i].get_cell("Vt_Header"); //get reference to the cells you want to validate


                            var idGUID = batchManager.getCellValue(idCellGUID); //retrieve the value from the cell using the BatchEditingManager 

                            if (idGUID == "") {
                                if (idGUID == "") msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("Vt_Header").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าว่างเปล่า%>" + "<br/>";
                        ...
                        if (itemCNT >= 0) {
                            msg += "<%= Me.GridShowdata.MasterTableView.GetColumn("Vt_Header").HeaderText%>" + " " + "<%=Sys.TMsg.ไม่สามารถมีค่าซ้ำ%>" + "<br/>";
                            validationFails = true;
                        }
                        else {
        ...
        <div>
            <telerik:RadGrid ID="GridShowdata" runat="server" AllowMultiRowEdit="True"
                ...
                PageSize="500" Height="408px" OnItemDataBound="grid_ItemDataBound"
                ...
                <MasterTableView CommandItemDisplay="Top" CommandItemSettings-ShowRefreshButton="false"
                    ...
                    EditMode="Batch" EnableNoRecordsTemplate="true" DataKeyNames="GUID_Vt">
                    <BatchEditingSettings EditType="Cell" OpenEditingEvent="Click" />
                    <NoRecordsTemplate></NoRecordsTemplate>
                    <ItemStyle Height="28px" />
                    <AlternatingItemStyle Height="28px" />
                    <Columns>
                        <telerik:GridBoundColumn UniqueName="Vt_N" SortExpression="Vt_N" DataField="Vt_N" HeaderText="ลำดับ" HeaderStyle-Width="50px" AllowSorting="true" ColumnEditorID="txtEditor1" />
                        <telerik:GridBoundColumn UniqueName="Vt_Header" SortExpression="Vt_Header" DataField="Vt_Header" HeaderText="หัวข้อ" HeaderStyle-Width="130px" AllowSorting="true" ColumnEditorID="txtEditor2"/>
                        <telerik:GridBoundColumn UniqueName="Vt_Name" SortExpression="Vt_Name" DataField="Vt_Name" HeaderText="เนื้อหา" HeaderStyle-Width="400px" AllowSorting="true" ColumnEditorID="txtEditor3"/>
                        <telerik:GridBoundColumn UniqueName="Vt_Hour" SortExpression="Vt_Hour" DataField="Vt_Hour" HeaderText="จำนวนชั่วโมง" HeaderStyle-Width="80px" AllowSorting="true" ColumnEditorID="txtEditor1"/>
            ...
            <telerik:GridTextBoxColumnEditor ID="txtEditor1"  runat="server" TextBoxStyle-Width ="39px" ></telerik:GridTextBoxColumnEditor> 
            <telerik:GridTextBoxColumnEditor ID="txtEditor2"  runat="server" TextBoxStyle-Width ="119px" ></telerik:GridTextBoxColumnEditor> 
            <telerik:GridTextBoxColumnEditor ID="txtEditor3"  runat="server" TextBoxStyle-Width ="389px" ></telerik:GridTextBoxColumnEditor>                 
