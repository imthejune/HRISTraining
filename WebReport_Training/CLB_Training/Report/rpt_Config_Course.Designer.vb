Partial Class rpt_Config_Course

    'NOTE: The following procedure is required by the telerik Reporting Designer
    'It can be modified using the telerik Reporting Designer.  
    'Do not modify it using the code editor.
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rpt_Config_Course))
        ...
        'pageHeaderSection1
        '
        Me.pageHeaderSection1.Height = Telerik.Reporting.Drawing.Unit.Cm(1.7462503910064697R)
        ...
        Me.txtN.Value = "= Fields.Course_Code"
        '
        'TextBox1
        '
        ...
        Me.TextBox1.Value = "= Fields.Course_NameT"
        '
        'pageFooterSection1
        '
