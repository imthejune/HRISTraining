...
Partial Public Class rpt_sub_yearNu2Stand
    Inherits Telerik.Reporting.Report

    Const CodeReport As String = "rpt_sub_yearNu2Stand"  ' รหัสรายงาน
    ...
    Private Sub rpt_sub_yearNu2Stand_ItemDataBinding(sender As Object, e As EventArgs) Handles Me.ItemDataBinding
        '---- โหลดครั้งแรก
