...
Partial Public Class rpt_Nottrainyear
    Inherits Telerik.Reporting.Report

    Const CodeReport As String = "rpt_Nottrainyear"  ' รหัสรายงาน
    ...
    Private Sub rpt_Nottrainyear_ItemDataBinding(sender As Object, e As EventArgs) Handles Me.ItemDataBinding
