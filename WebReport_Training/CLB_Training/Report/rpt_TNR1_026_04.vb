...
Partial Public Class rpt_TNR1_026_04
    Inherits Telerik.Reporting.Report
    Const CodeReport As String = "TNR1_026_04"  ' รหัสรายงาน
    ...
    Private Sub rpt_TNR1_026_04_ItemDataBinding(sender As Object, e As EventArgs) Handles Me.ItemDataBinding
        Lang()
    End Sub
    Sub Lang()
