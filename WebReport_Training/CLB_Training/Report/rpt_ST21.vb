...
Partial Public Class rpt_ST21
    ...
    Sub ShowGroupReport()
        ...
        If ConfigReport.GET_TEXT3 <> "" Then
            TextBox4.Value = ConfigReport.GET_TEXT3.ToString.Split("/")(0)
            'TextBox4.Value = DateTime.ParseExact(ConfigReport.GET_TEXT3, "dd/MM/yyyy", CultureInfo.CurrentCulture)
            TextBox32.Value = ConfigReport.GET_TEXT3.ToString.Split("/")(1)
            TextBox5.Value = ConfigReport.GET_TEXT3.ToString.Split("/")(2)
        End If
    ...
    Private Sub rpt_Config_Group_ItemDataBinding(sender As Object, e As EventArgs) Handles Me.ItemDataBinding
        ...
        Dim rpt As rpt_ST21 = New rpt_ST21()
