...
Partial Public Class rpt_FyFp1
    ...
    Sub ShowGroupReport()
        ...
        txt_From.Value = ConfigReport.GET_TEXT1 'โดย
        TextBox119.Value = ConfigReport.GET_TEXT2 'รายละเอียดที่เกี่ยวกับหลักสูตรและค่าใช้จ่ายในการฝึกอบรมแต่ละหลักสูตร
        TextBox120.Value = ConfigReport.GET_TEXT3 'รายชื่อผู้รับการฝึกอบรม
        TextBox121.Value = ConfigReport.GET_TEXT4 'สำเนาหลักฐานค่าใช้จ่ายในการฝึกอบรม
        TextBox123.Value = ConfigReport.GET_TEXT5 'ตำแหน่ง
