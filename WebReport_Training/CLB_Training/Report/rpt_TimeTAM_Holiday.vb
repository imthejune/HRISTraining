...
Partial Public Class rpt_TimeTAM_Holiday
    Inherits Telerik.Reporting.Report
    Const CodeReport As String = "TAR_016_06"  ' รหัสรายงาน
    ...
    Private Sub rpt_TimeTAM_Holiday_ItemDataBinding(sender As Object, e As EventArgs) Handles Me.ItemDataBinding
        '---- โหลดครั้งแรก
        DataSource.ConnectionString = ConfigReport.SQL_Connection

        Me.Txt_CompanyName.Value = ConfigReport.LoadCompanyName() ' หัวรายงาน ชื่อบีิษัท
        ...
        'ShowGroupReport()  ' แสดง Group รายงาน

        Me.Txt_ISO.Value = ConfigReport.GET_ISO(CodeReport)  ' ISO
        Me.TxtDatePrint.Value = ConfigReport.GET_DatePrint   ' วันที่ เวลา ท้ายกระดาษ
        Me.Txt_ReportName.Value = ConfigReport.ReportName & " " & ShowTxtReport  ' แสดงหัวรายงาน
    ...
    Sub Lang()
        ...
        If ConfigReport.ShowLang <> "T" Then
            ...
            'ConfigReport.ChangNamePerson(txt_Leave_Name)
            'ConfigReport.ChangNamePerson(txt_SurName)
