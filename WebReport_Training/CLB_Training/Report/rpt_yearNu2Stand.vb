...
Partial Public Class rpt_yearNu2Stand
    Inherits Telerik.Reporting.Report

    Const CodeReport As String = "rpt_yearNu2Stand"  ' รหัสรายงาน
    ...
    Private Sub rpt_yearNu2Stand_ItemDataBinding(sender As Object, e As EventArgs) Handles Me.ItemDataBinding
        ...
        'SubYearNu2St.ReportSource = CL_sub_YearNu2Stand
        'SubYearNu2St.Parameters.Add(Parameter_YearNu2Stand)
    ...
    Sub ShowGroupReport()
        ...
        'Me.Groups(2).Groupings.RemoveAt(0)
        'Me.Groups(2).Groupings.Add("= Fields.GUID_Patern ")
        'Me.Groups(2).DocumentMapText = "= Fields.PaternRefName "
