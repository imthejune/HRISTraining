...
Partial Public Class rpt_Alert1
    Inherits Telerik.Reporting.Report

    Const CodeReport As String = "rpt_Alert1"  ' รหัสรายงาน
    ...
    Private Sub rpt_Alert1_ItemDataBinding(sender As Object, e As EventArgs) Handles Me.ItemDataBinding
    ...
    Sub ShowGroupReport()
        ...
        Me.Groups(0).Groupings.Add("= Fields.PrositionName")
        Me.Groups(0).DocumentMapText = "= Fields.PrositionName"

        detail.DocumentMapText = "= Fields.SubTrainName "
